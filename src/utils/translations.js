export const EN_TRANSLATIONS = {
    ...
    "优秀": "Excellent",
    "惊艳": "Stunning",
    "合成成功": "Merge successful",
    "选择2个相同物品进行合成": "Select 2 identical items to merge",
    "确认合成": "Confirm merge",
    "合成": "Merge",
    "合成为高品质物品": "Merge into higher quality",
    // --- Ingredient tags ---
    ...
    "大嗓门": "Loudmouth",
    "大嗓门被驱散！": "Loudmouth dispelled!",
    "抽中时驱散，并清除场上所有抢菜人；在场时每次抽取后空出的格子会被填入抢菜人": "Drawing it dispels the Loudmouth and clears every Grabber on the board; while present, each emptied cell is refilled with a Grabber",
    "交换区": "Exchange",
    ...
    "硬化的": "Hardened",
    "稀有度更高，但物品带有【绝育】效果，无法合成。": "Higher rarity, but items are [Sterile] and cannot be merged.",
    "提纯的": "Purified",
    ...
    "黏糊糊的一摊": "Slimy Puddle",
    "黏糊糊的一坨": "Slimy Lump",
    "黏糊糊的东西，沾手甩不掉": "Slimy stuff, can't shake it off",
