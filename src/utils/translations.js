export const EN_TRANSLATIONS = {
    ...
    "背包扩容": "Backpack Expand",
    "抽中时增加背包容量": "Increases backpack capacity when drawn",
    "重力开关": "Gravity Switch",
    ...
    "快速指南": "Quick Guide",
    "游戏目标": "Goal",
    "完成 3 场探险，累计获得 ≥30 分即为胜利。每场探险中收集贴纸、完成订单获得得分物品，然后撤离带出分数。": "Complete 3 expeditions and score ≥30 total to win. Each expedition: collect stickers, complete orders for score items, then evacuate to bank your points.",
    "回合流程": "Turn Flow",
    "选墙": "Pick Wall",
    ...
    "抽取规则": "Drawing",
    "每回合获得一定金币，每次抽取花 1 金币。选择奖品墙的一行或一列，随机抽中其中 1 格。不必用完所有金币。": "Get gold each turn, each draw costs 1. Pick a row or column on the Prize Wall — 1 random cell is drawn. You don't have to spend all gold.",
    "格子类型": "Cell Types",
    "收集完成订单": "Collect for orders",
    "触发厄运，可能扣血": "Triggers doom, may lose HP",
    "厄运更危险": "Doom gets worse",
    "得分物品": "Score Item",
    "直接获得分数物品": "Get score item directly",
    "获得新订单": "Get a new order",
    "获得额外金币": "Get extra gold",
    "爆炸摧毁周围格子": "Destroys surrounding cells",
    "回复生命值": "Restore HP",
    "增加背包容量": "Expand backpack",
    "格子向下坠落": "Cells fall down",
    "订单与贴纸": "Orders & Stickers",
    "从左侧公告牌接取订单（只显示奖励和难度，接取后才揭示所需贴纸）": "Accept orders from the bulletin board (shows reward & difficulty only — requirements revealed on accept)",
    "在奖品墙上抽取贴纸，收集订单所需的种类和数量": "Draw stickers from the wall to collect the types and amounts your orders need",
    "随时提交已完成的订单，获得得分物品放入背包": "Submit completed orders anytime to get score items into your backpack",
    "厄运系统": "Doom System",
    ...
    "HP 归零 = 丢失全部背包物品，强制撤离，本场 0 分": "HP 0 = lose entire backpack, forced evacuation, 0 points this round",
    "撤离决策": "Evacuation",
    "回合结束后可选择撤离，背包中的得分物品转化为分数": "After each turn you can evacuate — score items in backpack become points",
    "继续 = 更多收集机会，但厄运在不断积累！": "Staying = more loot, but doom keeps building!",
    "关键数值": "Key Numbers",
    "奖品墙大小": "Wall Size",
    "背包容量": "Backpack",
    "每场生命值": "HP / Round",
