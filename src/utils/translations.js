export const EN_TRANSLATIONS = {
    ...
    "请点击选择一个目标物品": "Click to select a target item",
    "取消工具使用": "Cancel Tool Use",
    "待处理": "Pending",
    "种类过载": "Type Overload",
    "已在其他订单中使用": "Already used in another order",
    "点击使用工具": "Click to use tool",
    "点击取回": "Click to take back",
    "点击合成": "Click to synthesize",
    "无法继续操作！": "Cannot continue!",
    "调试：已获取订单所需物品": "Debug: Order items obtained",
    "金币陷阱": "Gold Trap",
    "炸弹": "Bomb",
    "💣 炸弹爆炸！": "Bomb exploded!",
    "该订单不需要此物品，或对应槽位已有物品": "Order does not need this item, or slot already filled",
    "扣除{cost}金币": "Deducts {cost} gold",
    "炸弹：摧毁周围8格": "Bomb: destroys 8 surrounding cells",
};
