export const EN_TRANSLATIONS = {
    ...
    "结束抽奖": "End Draws",
    "抽奖结束": "Draws Complete",
    "下次进入抽奖将添加一个厄运标记": "Next draws start with one more doom marker",
    "继续": "Continue",
    ...
    "蛋奶": "Dairy", "蛋": "Egg", "奶": "Milk", "豆腐": "Tofu", "奶酪": "Cheese",
    // 品类 tags (variety names, Chinese → English)
    "鸡胸肉": "Chicken Breast", "鸡腿肉": "Chicken Thigh", "鸡翅": "Chicken Wing", "鸡里脊": "Chicken Tenderloin",
    "牛肉碎": "Ground Beef", "牛腩": "Beef Brisket", "牛排": "Beef Steak", "牛里脊": "Beef Tenderloin",
    "猪肉碎": "Ground Pork", "五花肉": "Pork Belly", "排骨": "Pork Ribs", "猪里脊": "Pork Tenderloin",
    "羊肉碎": "Ground Lamb", "羊腿": "Lamb Leg", "羊排": "Lamb Chop", "羊里脊": "Lamb Tenderloin",
    "沙丁鱼": "Sardine", "鲈鱼": "Sea Bass", "三文鱼": "Salmon", "金枪鱼": "Tuna",
    "河虾": "River Shrimp", "基围虾": "White Shrimp", "明虾": "Tiger Prawn", "牡丹虾": "Spot Prawn",
    "蛤蜊": "Clam", "青口": "Mussel", "扇贝": "Scallop", "鲍鱼": "Abalone",
    "花蟹": "Blue Crab", "梭子蟹": "Swimming Crab", "面包蟹": "Dungeness Crab", "帝王蟹": "King Crab",
    "白菜": "Cabbage", "菠菜": "Spinach", "生菜": "Lettuce", "油菜": "Bok Choy",
    "土豆": "Potato", "红薯": "Sweet Potato", "芋头": "Taro", "莲藕": "Lotus Root",
    "苹果": "Apple", "柠檬": "Lemon", "芒果": "Mango", "草莓": "Strawberry",
    "平菇": "Oyster Mushroom", "香菇": "Shiitake", "金针菇": "Enoki", "杏鲍菇": "King Oyster",
    "粳米": "White Rice", "糙米": "Brown Rice", "茉莉香米": "Jasmine Rice", "紫米": "Purple Rice",
    "挂面": "Dried Noodles", "鸡蛋面": "Egg Noodles", "荞麦面": "Buckwheat Noodles", "乌冬面": "Udon",
    "黄豆": "Soybean", "红豆": "Red Bean", "绿豆": "Mung Bean", "鹰嘴豆": "Chickpea",
    "白面包": "White Bread", "全麦面包": "Whole Wheat Bread", "酸面包": "Sourdough", "法棍": "Baguette",
    "鸡蛋": "Chicken Egg", "鸭蛋": "Duck Egg", "鹌鹑蛋": "Quail Egg", "鹅蛋": "Goose Egg",
    "牛奶": "Cow Milk", "羊奶": "Goat Milk", "水牛奶": "Buffalo Milk", "驼奶": "Camel Milk",
    "嫩豆腐": "Silken Tofu", "老豆腐": "Firm Tofu", "冻豆腐": "Frozen Tofu", "腐竹": "Yuba",
    "马苏里拉": "Mozzarella", "切达": "Cheddar", "布里": "Brie", "帕玛森": "Parmesan",
    // Quality prefix translations
    "普通": "Regular", "精选": "Choice", "优质": "Premium", "顶级": "Top-grade",
    // --- Dish/slot names ---
    ...
    "选择一位厨师,开始你的故事": "Choose a chef to begin your story",
    "选一位厨师，开始你的故事": "Choose a chef to begin your story",
    "选一位厨师,开始你的故事": "Choose a chef to begin your story",
    "无名厨师": "Nameless Chef",
    "信号切换": "SIGNAL SWITCH",
    ...
    "重置": "Reset",
    "今日结束": "End Day",
    "下一站去哪里？": "Where to next?",
    "进入一家店将消耗 1 小时": "Entering a shop costs 1 hour",
    "主营": "Sells",
    "12 小时已用完。点击右上角「今日结束」开始结算。": "12 hours used. Press End Day to settle.",
    "离开店": "Leave Shop",
    "所有已入篮的东西会并入冰箱": "Basket contents will move to fridge",
    "鼠标悬停预览 2×2，点击任一格即以其为左上角抽取": "Hover to preview 2×2; click locks the top-left anchor",
    "从高亮的 2×2 中点击一格抽取": "Pick one cell from the highlighted 2×2",
    "取消": "Cancel",
    "本次词缀": "Draw affix",
    "精准：2 选 1": "Precise: pick 1 of 2",
    "你可以看到这两个候选的品质。选一个进篮。": "Both qualities revealed. Choose one.",
    "选它会被踢出": "Picking this kicks you out",
    "香蕉皮": "Banana Peel",
    "香蕉皮 —— 抽中会被踢出店": "Banana peel — drawing kicks you out",
    "临时篮": "Basket",
    "冰箱": "Fridge",
    "安全撤离时合并到冰箱；抽到香蕉皮会全部丢失": "Safe exit → contents move to fridge. Banana peel → lose all.",
    "已选中。点击菜上的空槽放入": "Selected. Click an empty dish slot to place.",
    "点击一个食材选中，再点击菜的空槽放入": "Click an ingredient to select, then click an empty dish slot.",
    "确定": "Confirm",
    "三格全填才能确定": "All 3 slots must be filled before confirming",
    "未完成": "Unfinished",
    "Day 1 · 厨师的一天": "Day 1 · A Chef's Day",
    "开始": "Start",
    "再玩一次": "Play Again",
    "再来一局": "Try Again",
    "满意度归零 —— 餐厅关门了": "Satisfaction hit zero — the restaurant closes.",
    "新来的物品": "Incoming item",
    "队列中还有": "Queued",
    "临时篮已满": "Basket Full",
    "替换一个旧物品，或扔掉新的": "Replace an item or discard the new one",
    "冰箱已满": "Fridge Full",
    "替换一个冰箱里的物品，或扔掉新的": "Replace a fridge item or discard the new one",
    "点击下面要被替换的物品，或选择扔掉新物品": "Click an item below to replace, or discard the new one",
    "扔掉新物品": "Discard New",
    "被踢出": "Kicked out of",
    "临时篮全部损失": "basket lost",

    // ── 评级 ──（对照 game_rules.md 中文术语）
    "翻车": "Failed",
    "勉强": "Barely",
    "合格": "Satisfactory",
    "优秀": "Excellent",
    ...
    "硬化": "Hardened",
    "提纯": "Purified",
    "在 2×2 中随机展示两个候选的品质，你选一个。": "Reveals 2 candidates with quality; pick one.",
    "在 2×2 中自选一格抽取（不预览品质）。": "Pick 1 cell yourself (quality hidden until drawn).",
    "在 2×2 中独立抽三次（可能撞同格），全部为普通品质。": "Draw 3 times from the 2×2 (may collide); all Common quality.",
    "品质保底 ★★ 或更高。": "Minimum quality ★★.",
