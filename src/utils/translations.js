export const EN_TRANSLATIONS = {
    ...
    "快速指南": "Quick Guide",
    "游戏目标": "Goal",
    "完成 3 个营业日，累计获得 ≥30 分即可挽救你的餐厅。每天收集贴纸、完成订单获得食材，然后打烊结算分数。": "Complete 3 business days and earn ≥30 points to save your restaurant. Each day: collect stickers, fill orders to earn ingredients, then close up to bank your score.",
    "回合流程": "Turn Flow",
    "选墙": "Pick Board",
    "花金币抽取": "Spend Gold to Draw",
    "厄运积累": "Doom Grows",
    "新订单": "New Order",
    "继续或打烊": "Continue or Close",
    "抽取规则": "Drawing",
    ...
    "HP 归零 = 丢失全部菜篮物品，强制打烊，本日 0 分": "HP 0 = lose entire basket, forced to close, 0 points this day",
    "打烊决策": "Closing Time",
    "回合结束后可选择打烊，菜篮中的食材转化为分数": "After each turn you can close up — ingredients in your basket become points",
    "继续营业 = 更多食材，但厄运在不断积累！": "Staying open = more ingredients, but doom keeps building!",
