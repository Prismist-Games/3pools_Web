export const EN_TRANSLATIONS = {
    ...
    "主角": "You",
    "老板": "Shopkeeper",
    "自己找去！这边都忙不过来！": "Find it yourself! I'm slammed here!",
    "把食材放进对应槽位": "Drop ingredients into the matching slots",
    "点击前往菜市场": "Head to the market",
    "点击抽取这一行或这一列抽取鸡蛋面": "Draw this row or column to grab egg noodles",
    "相同品质的同名食材可以合成，尝试合成到三星挂面": "Combine two same-quality matching items to upgrade — try to reach 3★ noodles",
    "抽到的食材是这一行（或列）4 格里随机选 1 个；\n品质也是抽到之后才随机决定。": "What you grab is one of the 4 cells in that row (or column), picked at random;\nits quality is also rolled after the draw.",
    "点击此处挤出店铺": "Click to squeeze out of the shop",
    "挤出店铺需要穿越人群，运气不好的话，菜篮可能会被挤到": "Squeezing out means cutting through the crowd — your basket may take a hit if luck's against you",
    "去海鲜店": "Head to the seafood market",
    "先用透视看品质": "Try Peek to check qualities first",
    "点击抽取这一行或这一列抽取明虾": "Draw this row or column to grab the tiger prawn",
    "点击此处进行食材交换": "Click here to trade for ingredients",
    "回餐厅": "Back to the restaurant",
    "凑一顿出来": "Put together what you've got",
    "——成了。这下就跟老妈做的一个味儿。": "— There. Tastes just like Mom's now.",
    "要先去买明虾": "Grab the tiger prawn first",
    "把抽数用完再走": "Use all your draws first",
    "先把订单提交了再走": "Submit the order before leaving",
    "今天先回餐厅": "Head back to the restaurant for today",
    ...
    "耐久度": "Durability",
    "耐久": "Durability",
    "成功挤出人群": "Pushed Through the Crowd",
    "下次进店人群将会更多": "The crowd will be larger next visit",
    "挤出店铺": "Squeeze Out",
    "菜篮只剩个把儿": "Only the Basket Handle Left",
    "抢菜人": "Grabber",
    "抽中时触发抢菜人，不获得物品": "Triggers Grabber when drawn — no item obtained",
    "接下来去哪儿？": "Where to next?",
    "只能抢到海鲜类食材": "Only seafood can be grabbed here",
    "只能抢到肉类食材": "Only meat can be grabbed here",
    "只能抢到主食类食材": "Only staples can be grabbed here",
    "只能抢到蔬菜·水果·菌菇类食材": "Only vegetables / fruit / mushrooms can be grabbed here",
    "只能抢到蛋奶制品": "Only dairy and eggs can be grabbed here",
    "人群": "Crowd",
    "人挤人": "Crowd Crush",
    "抽中时触发人挤人": "Draws a Crowd Crush",
    // --- Tool system ---
    "道具栏": "Tools",
    "空": "Empty",
    "道具": "Tool",
    "获得道具": "Obtained",
    "抽中时获得此道具": "Obtain this tool when drawn",
    "获得新道具": "New Tool Obtained",
    "道具栏已满,请选择替换现有道具,或放弃新道具": "Tools full — replace one or discard the new tool",
    "替换以下道具之一:": "Replace one:",
    "放弃新道具": "Discard New Tool",
    "透视": "Peek",
    "揭示一行或一列所有食材的品质": "Reveal ingredient qualities in a row or column",
    "换位": "Swap",
    "选择墙上任意 2 格交换位置": "Swap any 2 cells on the wall",
    "驱散": "Disperse",
    "丢弃墙上任意 1 格的内容": "Discard any 1 cell on the wall",
    "炸墙": "Blast Wall",
    "炸掉一个 3×3 区域,重新填充": "Blast a 3×3 region and refill",
    "清库换抽": "Trade-in Draw",
    "丢弃 1 格菜篮食材,换 1 抽数": "Discard 1 basket item for +1 draw",
    "交换区": "Exchange",
    "交换区已满，选择下方订单替换": "Exchange full — select one below to replace",
    "在左侧交换区点击要替换掉的订单": "Click an order in the Exchange to replace",
    "选择一个加入交换区": "Add one to the Exchange",
    "从左侧交换区接取订单（只显示奖励和难度，接取后才揭示所需贴纸）": "Accept orders from the Exchange (only reward & difficulty shown — requirements revealed on accept)",
    "输入名字上榜": "Enter Name",
    "你的成绩": "Score",
    "次": "Draws",
    "玩家": "Player",
    ...
    "点击选择要丢弃的物品": "Click items to select for discarding",
    "丢弃不需要的物品": "Discard unwanted items",
    "合成": "Synthesize",
    "选择2个相同物品进行合成": "Select 2 identical items to synthesize",
    ...
    "从以下选择一种": "Choose one of the following",
    "没有合格的食材": "No eligible ingredients",
    "确认提交": "Confirm",
    "浏览": "view only",
