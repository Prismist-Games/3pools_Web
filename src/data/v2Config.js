...
export const INGREDIENTS = [
    ...
    // { id: 'chicken_tenderloin',icon: '🍗', name: '鸡里脊',   nameEn: 'Chicken Tenderloin',  shortLabel: '脊', shortLabelEn: 'Tl', tags: ['肉类', '鸡'] }, // disabled: 缩减至3
    // ── 肉类 · 牛 ──
    ...
    // { id: 'beef_tenderloin',   icon: '🥩', name: '牛里脊',   nameEn: 'Beef Tenderloin',     shortLabel: '脊', shortLabelEn: 'Tl', tags: ['肉类', '牛'] }, // disabled: 缩减至3
    // ── 肉类 · 猪 ──
    ...
    // { id: 'pork_tenderloin',   icon: '🥓', name: '猪里脊',   nameEn: 'Pork Tenderloin',     shortLabel: '脊', shortLabelEn: 'Tl', tags: ['肉类', '猪'] }, // disabled: 缩减至3
    // ── 肉类 · 羊 ──
    ...
    // { id: 'lamb_tenderloin',   icon: '🍖', name: '羊里脊',   nameEn: 'Lamb Tenderloin',     shortLabel: '脊', shortLabelEn: 'Tl', tags: ['肉类', '羊'] }, // disabled: 缩减至3

    // ── 海鲜 · 鱼 ──
    // { id: 'sardine',           icon: '🐟', name: '沙丁鱼',   nameEn: 'Sardine',             shortLabel: '沙', shortLabelEn: 'Sd', tags: ['海鲜', '鱼'] }, // disabled: 缩减至3
    ...
    // { id: 'spot_prawn',        icon: '🦐', name: '牡丹虾',   nameEn: 'Spot Prawn',          shortLabel: '丹', shortLabelEn: 'Sp', tags: ['海鲜', '虾'] }, // disabled: 缩减至3
    // ── 海鲜 · 贝 ──
    ...
    // { id: 'abalone',           icon: '🐚', name: '鲍鱼',     nameEn: 'Abalone',             shortLabel: '鲍', shortLabelEn: 'Ab', tags: ['海鲜', '贝'] }, // disabled: 缩减至3
    // ── 海鲜 · 蟹 ──
    ...
    // { id: 'king_crab',         icon: '🦀', name: '帝王蟹',   nameEn: 'King Crab',           shortLabel: '帝', shortLabelEn: 'Ki', tags: ['海鲜', '蟹'] }, // disabled: 缩减至3
    ...
    // { id: 'rapeseed',          icon: '🥬', name: '油菜',     nameEn: 'Rapeseed',            shortLabel: '油', shortLabelEn: 'Ra', tags: ['蔬菜', '青菜'] }, // disabled: 缩减至3
    // ── 蔬菜 · 根茎 ──
    ...
    // { id: 'lotus_root',        icon: '🥔', name: '莲藕',     nameEn: 'Lotus Root',          shortLabel: '藕', shortLabelEn: 'Lo', tags: ['蔬菜', '根茎'] }, // disabled: 缩减至3
    // ── 蔬菜 · 水果 ──
    ...
    // { id: 'strawberry',        icon: '🍓', name: '草莓',     nameEn: 'Strawberry',          shortLabel: '莓', shortLabelEn: 'St', tags: ['蔬菜', '水果'] }, // disabled: 缩减至3
    // ── 蔬菜 · 菌菇 ──
    ...
    // { id: 'king_oyster',       icon: '🍄', name: '杏鲍菇',   nameEn: 'King Oyster Mushroom',shortLabel: '杏', shortLabelEn: 'KO', tags: ['蔬菜', '菌菇'] }, // disabled: 缩减至3
    ...
    // { id: 'black_rice',        icon: '🍚', name: '紫米',     nameEn: 'Black Rice',          shortLabel: '紫', shortLabelEn: 'Bk', tags: ['主食', '米'] }, // disabled: 缩减至3
    // ── 主食 · 面 ──
    ...
    // { id: 'udon',              icon: '🍜', name: '乌冬面',   nameEn: 'Udon',                shortLabel: '冬', shortLabelEn: 'Ud', tags: ['主食', '面'] }, // disabled: 缩减至3
    // ── 主食 · 豆 ──
    ...
    // { id: 'chickpea',          icon: '🫘', name: '鹰嘴豆',   nameEn: 'Chickpea',            shortLabel: '鹰', shortLabelEn: 'Ck', tags: ['主食', '豆'] }, // disabled: 缩减至3
    // ── 主食 · 面包 ──
    ...
    // { id: 'baguette',          icon: '🍞', name: '法棍',     nameEn: 'Baguette',            shortLabel: '棍', shortLabelEn: 'Bg', tags: ['主食', '面包'] }, // disabled: 缩减至3
    ...
    // { id: 'goose_egg',         icon: '🥚', name: '鹅蛋',     nameEn: 'Goose Egg',           shortLabel: '鹅', shortLabelEn: 'Go', tags: ['蛋奶制品', '蛋'] }, // disabled: 缩减至3
    // ── 蛋奶制品 · 奶 ──
    ...
    // { id: 'camel_milk',        icon: '🥛', name: '驼奶',     nameEn: 'Camel Milk',          shortLabel: '驼', shortLabelEn: 'Cm', tags: ['蛋奶制品', '奶'] }, // disabled: 缩减至3
    ...
    // { id: 'tofu_skin',         icon: '🥣', name: '腐竹',     nameEn: 'Tofu Skin',           shortLabel: '竹', shortLabelEn: 'Tk', tags: ['蛋奶制品', '豆腐'] }, // disabled: 缩减至3
    // ── 蛋奶制品 · 奶酪 ──
    ...
    // { id: 'parmesan',          icon: '🧀', name: '帕玛森',   nameEn: 'Parmesan',            shortLabel: '帕', shortLabelEn: 'Pm', tags: ['蛋奶制品', '奶酪'] }, // disabled: 缩减至3
];
